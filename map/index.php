...
<html>
    ...
    <body>
        ...
        <form method="GET" action="<?php print $_SERVER['PHP_SELF']; ?>">
            <h1>Show the average readings of NO, NO2 and NOX of all stations on the map</h1>
        ...
        <script
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCcW0x9hZiJS1nVHDxjtWhOPhlV2zAXHEQ&callback=initMap&v=weekly"
            defer
        ></script>
    </body>
</html>